                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="Details">
                            <div class="valu">
                              ...
                              <ul>
                                <li><i class="fa fa-circle"></i>{{$book->author}}</li>
                                <li><i class="fa fa-circle"></i>{{ $book->publisher}}</li>
                                <li><i class="fa fa-circle"></i>{{$book->publish_date}}</li>
                                <li><i class="fa fa-circle"></i>{{$book->language}}</li>
                              </ul>
                            </div>
                        </div>
